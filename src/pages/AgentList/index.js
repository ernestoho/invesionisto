    ...
    <>
      <div className="bg-gray_51 flex flex-col font-markoone gap-[100px] md:gap-[40px] sm:gap-[40px] items-start justify-start mx-[auto] md:w-[100%] sm:w-[100%] w-[auto]">
        <div className="flex flex-col gap-[56px] items-start justify-start w-[100%]">
          ...
          <div className="flex flex-col font-manrope items-center justify-center px-[120px] sm:px-[20px] md:px-[40px] w-[100%]">
            <div className="flex flex-col gap-[24px] items-center justify-center max-w-[1200px] mx-[auto] w-[100%]">
              ...
              <div className="flex md:flex-col sm:flex-col flex-row gap-[16px] items-center justify-start w-[100%]">
                <div className="bg-white_A700 border border-bluegray_100 border-solid flex flex-1 flex-col items-start justify-start px-[16px] py-[14px] rounded-radius10 md:self-stretch sm:self-stretch w-[100%]">
                  <Input
                ...
                <SelectBox
                  className="md:flex-1 sm:flex-1 font-bold pr-[16px] text-[18px] text-gray_600 text-left md:w-[100%] sm:w-[100%] w-[12%]"
          ...
          <div className="flex flex-col font-manrope md:gap-[40px] sm:gap-[40px] gap-[60px] items-start justify-start px-[120px] sm:px-[20px] md:px-[40px] w-[100%]">
            <div className="flex flex-col items-center justify-center max-w-[1200px] mx-[auto] w-[100%]">
              <div className="md:gap-[20px] sm:gap-[20px] gap-[24px] grid sm:grid-cols-1 md:grid-cols-2 grid-cols-4 justify-center min-h-[auto] w-[100%]">
                <div className="flex flex-1 flex-col h-[431px] md:h-[auto] sm:h-[auto] items-start justify-start md:self-stretch sm:self-stretch w-[100%]">
                  <Img
                    src="images/img_rectangle5615_282x282.png"
                    className="h-[282px] md:h-[auto] sm:h-[auto] object-cover rounded-bl-[0] rounded-br-[0] rounded-tl-[10px] rounded-tr-[10px] w-[100%]"
                    alt="Rectangle5615"
                  />
                  <div className="bg-white_A700 border border-bluegray_100 border-solid flex flex-col items-start justify-start px-[20px] py-[14px] rounded-bl-[10px] rounded-br-[10px] rounded-tl-[0] rounded-tr-[0] w-[100%]">
                    <div className="flex flex-col gap-[8px] items-start justify-start w-[100%]">
                      ...
                      <Button
                        className="cursor-pointer font-semibold text-[16px] text-center text-gray_900 w-[100%]"
                        shape="RoundedBorder10"
                        size="3xl"
                ...
                <div className="flex flex-1 flex-col h-[431px] md:h-[auto] sm:h-[auto] items-start justify-start md:self-stretch sm:self-stretch w-[100%]">
                  <Img
                    ...
                    className="h-[282px] sm:h-[auto] object-cover rounded-bl-[0] rounded-br-[0] rounded-tl-[10px] rounded-tr-[10px] w-[100%]"
                    alt="Rectangle5616"
                  />
                  <div className="bg-white_A700 border border-bluegray_100 border-solid flex flex-col items-start justify-start px-[20px] py-[14px] rounded-bl-[10px] rounded-br-[10px] rounded-tl-[0] rounded-tr-[0] w-[100%]">
                    <div className="flex flex-col gap-[8px] items-start justify-start w-[100%]">
