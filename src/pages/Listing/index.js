        ...
        <div className="flex flex-col md:gap-[40px] sm:gap-[40px] gap-[60px] items-center justify-center w-[100%]">
            ...
            <div className="flex flex-col gap-[24px] items-center justify-center max-w-[1200px] mx-[auto] w-[100%]">
              ...
              <div className="flex flex-col gap-[12px] items-start justify-start w-[100%]">
                <div className="flex md:flex-col sm:flex-col flex-row gap-[20px] items-start justify-start w-[100%]">
                  ...
                  ></SelectBox>
                  <SelectBox
                    className="md:flex-1 sm:flex-1 font-bold pr-[16px] text-[18px] text-gray_700 text-left md:w-[100%] sm:w-[100%] w-[11%]"
                    placeholderClassName="text-gray_700"
          ...
          <div className="flex flex-col font-manrope items-center justify-center px-[120px] sm:px-[20px] md:px-[40px] w-[100%]">
            <div className="flex md:flex-col sm:flex-col flex-row gap-[24px] items-start justify-center max-w-[1200px] mx-[auto] md:self-stretch sm:self-stretch w-[100%]">
              <div className="h-[511px] md:h-[auto] sm:h-[auto] relative md:w-[100%] sm:w-[100%] w-[32%]">
                <div className="h-[511px] md:h-[auto] sm:h-[auto] m-[auto] w-[100%]">
                  <GoogleMap
                    className="h-[511px] m-[auto] rounded-radius10 w-[100%]"
                    showMarker={false}
                  ></GoogleMap>
                  <Img
                ...
                <div className="absolute bg-white_A700 border border-gray_600 border-solid flex flex-col h-[max-content] inset-y-[0] items-center justify-start left-[7%] my-[auto] px-[16px] py-[24px] rounded-radius8 w-[308px]">
              ...
              <div className="flex flex-1 flex-col md:gap-[40px] sm:gap-[40px] gap-[60px] items-start justify-start md:self-stretch sm:self-stretch w-[100%]">
                <div className="flex flex-col items-start justify-start w-[100%]">
                  <div className="md:gap-[20px] sm:gap-[20px] gap-[24px] grid md:grid-cols-1 sm:grid-cols-1 grid-cols-2 justify-center min-h-[auto] w-[100%]">
