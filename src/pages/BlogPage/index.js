...
const BlogPagePage = () => {
  return (
    <>
      <div className="bg-gray_51 flex flex-col font-markoone items-start justify-start mx-[auto] md:w-[100%] sm:w-[100%] w-[auto]">
        <div className="flex flex-col md:gap-[40px] sm:gap-[40px] gap-[68px] items-center justify-start w-[100%]">
          ...
          <div className="flex flex-col font-manrope items-center justify-start px-[120px] sm:px-[20px] md:px-[40px] w-[100%]">
            <div className="flex flex-col md:gap-[40px] sm:gap-[40px] gap-[60px] items-center justify-start max-w-[1200px] mx-[auto] w-[100%]">
              <div className="flex flex-col gap-[24px] items-start justify-start w-[100%]">
                ...
                <div className="gap-[16px] grid sm:grid-cols-1 md:grid-cols-2 grid-cols-3 items-start justify-start w-[100%]">
                  <div className="bg-white_A700 border border-bluegray_100 border-solid flex flex-1 flex-col items-center justify-start px-[16px] py-[14px] rounded-radius10 md:self-stretch sm:self-stretch w-[100%]">
                    <Input
