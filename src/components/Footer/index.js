  ...
  return (
    <>
      <footer className={props.className}>
        <div className="flex flex-col gap-[120px] md:gap-[40px] sm:gap-[40px] items-center justify-center mb-[77px] mt-[100px] mx-[auto] w-[84%]">
          <div className="flex md:flex-col sm:flex-col flex-row md:gap-[20px] sm:gap-[20px] items-end justify-start w-[100%]">
            <div className="flex md:flex-1 sm:flex-1 flex-col gap-[50px] items-start justify-start md:w-[100%] sm:w-[100%] w-[42%]">
            ...
            <div className="bg-white_A700 flex md:flex-1 sm:flex-1 flex-col gap-[34px] items-start justify-start md:mt-[0] sm:mt-[0] mt-[20px] md:w-[100%] sm:w-[100%] w-[8%]">
              <Text
            ...
            <div className="bg-white_A700 flex md:flex-1 sm:flex-1 flex-col gap-[36px] items-start justify-start md:ml-[0] sm:ml-[0] ml-[83px] md:mt-[0] sm:mt-[0] mt-[20px] pb-[10px] md:w-[100%] sm:w-[100%] w-[12%]">
              <Text
                className="font-bold font-manrope text-gray_900 text-left w-[auto]"
                variant="body3"
              >
            ...
            <div className="bg-white_A700 flex md:flex-1 sm:flex-1 flex-col gap-[36px] items-start justify-start md:ml-[0] sm:ml-[0] ml-[83px] md:mt-[0] sm:mt-[0] mt-[20px] pb-[10px] md:w-[100%] sm:w-[100%] w-[11%]">
              <Text
                className="font-bold font-manrope text-gray_900 text-left w-[auto]"
                variant="body3"
              >
            ...
            <div className="bg-white_A700 flex md:flex-1 sm:flex-1 flex-col gap-[36px] items-start justify-start md:ml-[0] sm:ml-[0] ml-[83px] md:mt-[0] sm:mt-[0] mt-[20px] pb-[11px] pr-[11px] md:w-[100%] sm:w-[100%] w-[13%]">
              <Text
                className="font-bold font-manrope text-gray_900 text-left w-[auto]"
                variant="body3"
              >
          ...
          <Text
            className="font-manrope font-semibold md:ml-[0] sm:ml-[0] ml-[4px] text-gray_900 text-left w-[auto]"
            variant="body4"
          >
